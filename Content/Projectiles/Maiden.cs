...
namespace ChairMarker.Content.Projectiles
{
    internal class Maiden : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                player.ClearBuff(ModContent.BuffType<MaidenBuff>());
                Projectile.Kill();
            }
            if (player.HasBuff(ModContent.BuffType<MaidenBuff>()))
            {
        ...
        private void Visuals(bool foundTarget)
        {
            ...
            Lighting.AddLight(new Vector2(Projectile.Center.X - 30f, Projectile.Center.Y - 70f), Color.Cyan.ToVector3() * 0.78f);
